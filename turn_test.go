...
func TestThreadRunWithReplay(t *testing.T) {
	...
	client, err := newReplayClient(ctx, rpc.NewReplayTransport(runTranscript(info, "hello", "final")), info)
	if err != nil {
...
func TestThreadRunFailsOnTurnFailedNotification(t *testing.T) {
	...
	client, err := newReplayClient(ctx, rpc.NewReplayTransport(runFailedTranscript(info, "hello", "boom")), info)
	if err != nil {
		t.Fatalf("new client error: %v", err)
	}
	defer client.Close()
...
func TestThreadRunFailsOnCompletedFailedStatus(t *testing.T) {
	...
	client, err := newReplayClient(ctx, rpc.NewReplayTransport(runCompletedFailedTranscript(info, "hello", "completed boom")), info)
	if err != nil {
		t.Fatalf("new client error: %v", err)
	}
	defer client.Close()
...
func TestThreadRunReturnsStreamNextError(t *testing.T) {
	...
	client, err := newReplayClient(ctx, rpc.NewReplayTransport(runWithoutCompletionTranscript(info, "hello")), info)
	if err != nil {
		t.Fatalf("new client error: %v", err)
	}
	defer client.Close()
...
func TestResumeThreadWithReplay(t *testing.T) {
	...
	client, err := newReplayClient(ctx, rpc.NewReplayTransport(resumeTranscript(info)), info)
	if err != nil {
		t.Fatalf("new client error: %v", err)
	}
	defer client.Close()
