...
type ConfigRequirements struct {
	...
	// AllowedApprovalsReviewers corresponds to the JSON schema field
...
type EnvironmentAddParams struct {
	...
	// ExecServerURL corresponds to the JSON schema field "execServerUrl".
...
type ProcessResizePtyParams struct {
	...
	// New PTY size in character cells.
	Size ProcessResizePtyParamsSize `json:"size"`
}

// PTY size in character cells for `process/spawn` PTY sessions.
type ProcessResizePtyParamsSize struct {
	// Terminal width in character cells.
	Cols int `json:"cols"`
...
type ProcessSpawnParams struct {
	...
	//
	// Duplicate active handles are rejected on the same connection. The same handle
	// can be reused after the prior process exits.
	ProcessHandle string `json:"processHandle"`
...
type RealtimeVoicesList struct {
	// DefaultV1 corresponds to the JSON schema field "defaultV1".
	DefaultV1 RealtimeVoice `json:"defaultV1"`

	// DefaultV2 corresponds to the JSON schema field "defaultV2".
	DefaultV2 RealtimeVoice `json:"defaultV2"`

	// V1 corresponds to the JSON schema field "v1".
	V1 []RealtimeVoice `json:"v1"`

	// V2 corresponds to the JSON schema field "v2".
...
type RemoteControlClient struct {
	...
	// DeviceModel corresponds to the JSON schema field "deviceModel".
	DeviceModel *string `json:"deviceModel,omitempty"`

	// DeviceType corresponds to the JSON schema field "deviceType".
	DeviceType *string `json:"deviceType,omitempty"`

	// DisplayName corresponds to the JSON schema field "displayName".
	DisplayName *string `json:"displayName,omitempty"`

	// LastSeenAt corresponds to the JSON schema field "lastSeenAt".
	LastSeenAt *int `json:"lastSeenAt,omitempty"`
...
const RemoteControlClientsListOrderAsc RemoteControlClientsListOrder = "asc"
const RemoteControlClientsListOrderDesc RemoteControlClientsListOrder = "desc"
...
type RemoteControlPairingStartParams struct {
	// ManualCode corresponds to the JSON schema field "manualCode".
	ManualCode *bool `json:"manualCode,omitempty"`
}

type RemoteControlPairingStatusParams struct {
	// ManualPairingCode corresponds to the JSON schema field "manualPairingCode".
	ManualPairingCode *string `json:"manualPairingCode,omitempty"`

	// PairingCode corresponds to the JSON schema field "pairingCode".
...
type SanitizedCurrentTimeReadParamsJSON struct {
	// ThreadID corresponds to the JSON schema field "threadId".
	ThreadID string `json:"threadId"`
}

type SanitizedCurrentTimeReadResponseJSON struct {
	// Current time as whole Unix seconds.
	CurrentTimeAt int `json:"currentTimeAt"`
}
...
type SanitizedEnvironmentAddParamsJSON struct {
	// Optional WebSocket connection timeout. The server default applies when omitted.
	ConnectTimeoutMs *int `json:"connectTimeoutMs,omitempty"`
...
type SanitizedEnvironmentInfoParamsJSON struct {
	// EnvironmentID corresponds to the JSON schema field "environmentId".
	EnvironmentID string `json:"environmentId"`
}

type SanitizedEnvironmentInfoResponseJSON struct {
...
type SanitizedFuzzyFileSearchSessionStartParamsJSON struct {
	// Roots corresponds to the JSON schema field "roots".
	Roots []string `json:"roots"`
...
type SanitizedFuzzyFileSearchSessionStopParamsJSON struct {
	// SessionID corresponds to the JSON schema field "sessionId".
	SessionID string `json:"sessionId"`
}

type SanitizedFuzzyFileSearchSessionUpdateParamsJSON struct {
	// Query corresponds to the JSON schema field "query".
	Query string `json:"query"`
...
type SanitizedMockExperimentalMethodParamsJSON struct {
	// Test-only payload field.
	Value *string `json:"value,omitempty"`
}

type SanitizedMockExperimentalMethodResponseJSON struct {
...
// Terminate a running `process/spawn` session.
type SanitizedProcessKillParamsJSON struct {
	// Client-supplied, connection-scoped `processHandle` from `process/spawn`.
	ProcessHandle string `json:"processHandle"`
}

// Write stdin bytes to a running `process/spawn` session, close stdin, or both.
type SanitizedProcessWriteStdinParamsJSON struct {
	// Close stdin after writing `deltaBase64`, if present.
	CloseStdin *bool `json:"closeStdin,omitempty"`
...
type SanitizedRemoteControlClientsListParamsJSON struct {
	// Cursor corresponds to the JSON schema field "cursor".
	Cursor *string `json:"cursor,omitempty"`
...
type SanitizedRemoteControlClientsListResponseJSON struct {
	// Data corresponds to the JSON schema field "data".
...
type SanitizedRemoteControlClientsRevokeParamsJSON struct {
	// ClientID corresponds to the JSON schema field "clientId".
	ClientID string `json:"clientId"`
...
type SanitizedRemoteControlDisableResponseJSON struct {
	// EnvironmentID corresponds to the JSON schema field "environmentId".
...
type SanitizedRemoteControlEnableResponseJSON struct {
	// EnvironmentID corresponds to the JSON schema field "environmentId".
	EnvironmentID *string `json:"environmentId,omitempty"`
...
type SanitizedRemoteControlPairingStartParamsJSON struct {
	// ManualCode corresponds to the JSON schema field "manualCode".
	ManualCode *bool `json:"manualCode,omitempty"`
}

type SanitizedRemoteControlPairingStartResponseJSON struct {
	// EnvironmentID corresponds to the JSON schema field "environmentId".
	EnvironmentID string `json:"environmentId"`
...
type SanitizedRemoteControlPairingStatusParamsJSON struct {
	// ManualPairingCode corresponds to the JSON schema field "manualPairingCode".
	ManualPairingCode *string `json:"manualPairingCode,omitempty"`
...
type SanitizedRemoteControlPairingStatusResponseJSON struct {
...
type SanitizedRemoteControlStatusReadResponseJSON struct {
	// EnvironmentID corresponds to the JSON schema field "environmentId".
	EnvironmentID *string `json:"environmentId,omitempty"`
...
type SanitizedThreadBackgroundTerminalsCleanParamsJSON struct {
	// ThreadID corresponds to the JSON schema field "threadId".
	ThreadID string `json:"threadId"`
}

type SanitizedThreadBackgroundTerminalsListParamsJSON struct {
	// Opaque pagination cursor returned by a previous call.
	Cursor *string `json:"cursor,omitempty"`
...
type SanitizedThreadBackgroundTerminalsTerminateParamsJSON struct {
	// ProcessID corresponds to the JSON schema field "processId".
	ProcessID string `json:"processId"`
...
type SanitizedThreadBackgroundTerminalsTerminateResponseJSON struct {
	// Terminated corresponds to the JSON schema field "terminated".
...
type SanitizedThreadDecrementElicitationParamsJSON struct {
	// Thread whose out-of-band elicitation counter should be decremented.
	ThreadID string `json:"threadId"`
}

// Response for `thread/decrement_elicitation`.
type SanitizedThreadDecrementElicitationResponseJSON struct {
...
type SanitizedThreadIncrementElicitationParamsJSON struct {
	// Thread whose out-of-band elicitation counter should be incremented.
	ThreadID string `json:"threadId"`
}

// Response for `thread/increment_elicitation`.
type SanitizedThreadIncrementElicitationResponseJSON struct {
...
type SanitizedThreadItemsListParamsJSON struct {
...
type SanitizedThreadListParamsJSON struct {
	...
	// excluding the ancestor itself. Mutually exclusive with `parentThreadId`.
	...
	// Optional direct parent thread filter. Mutually exclusive with
	// `ancestorThreadId`.
...
type SanitizedThreadMemoryModeSetParamsJSON struct {
	// Mode corresponds to the JSON schema field "mode".
...
type SanitizedThreadRealtimeAppendAudioParamsJSON struct {
...
type SanitizedThreadRealtimeAppendSpeechParamsJSON struct {
...
type SanitizedThreadRealtimeAppendTextParamsJSON struct {
	// Role corresponds to the JSON schema field "role".
...
type SanitizedThreadRealtimeListVoicesResponseJSON struct {
	// Voices corresponds to the JSON schema field "voices".
...
type SanitizedThreadRealtimeStartParamsJSON struct {
	// Leaves Codex response handoffs to the client's explicit append calls instead of
	// forwarding them automatically. Defaults to false.
	...
	// `conversation.handoff.append` when `codexResponsesAsItems` is not true. Final
	// answers are sent without the prefix.
	CodexResponseHandoffPrefix *string `json:"codexResponseHandoffPrefix,omitempty"`

	// Optional prefix added to automatic Codex response items when
	// `codexResponsesAsItems` is true.
	CodexResponseItemPrefix *string `json:"codexResponseItemPrefix,omitempty"`

	// Sends automatic Codex responses as realtime conversation items instead of
	// handoff appends.
	CodexResponsesAsItems *bool `json:"codexResponsesAsItems,omitempty"`

	// Set to false to start without Codex's startup context. Omitted or null includes
	// it.
	...
	// independent so clients can choose how they connect separately from what the
	// model emits.
	OutputModality interface{} `json:"outputModality"`
...
type SanitizedThreadRealtimeStopParamsJSON struct {
	// ThreadID corresponds to the JSON schema field "threadId".
	ThreadID string `json:"threadId"`
}
...
type SanitizedThreadSearchParamsJSON struct {
	// Optional archived filter; when set to true, only archived threads are returned.
	// If false or null, only non-archived threads are returned.
	Archived *bool `json:"archived,omitempty"`
...
type SanitizedThreadTurnsListParamsJSON struct {
	...
	ItemsView interface{} `json:"itemsView,omitempty"`
...
type SanitizedTurnSteerParamsJSON struct {
	// Optional client-provided context fragments keyed by an opaque source
	// identifier.
	...
	// `client_metadata["x-codex-turn-metadata"]` on ResponsesAPI HTTP and websocket
	// requests.
	//
	// They are not sent as top-level ResponsesAPI `client_metadata` keys, and
	// reserved keys such as `session_id`, `thread_id`, `turn_id`, and `window_id`
