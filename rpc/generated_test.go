...
func (h *recordingHandler) CurrentTimeRead(ctx context.Context, params protocol.CurrentTimeReadParams) (*protocol.CurrentTimeReadResponse, error) {
	h.lastMethod = "currentTime/read"
	resp := protocol.CurrentTimeReadResponse{CurrentTimeAt: 1}
	return &resp, nil
}
