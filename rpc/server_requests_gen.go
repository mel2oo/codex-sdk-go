...
type ServerRequestHandler interface {
	...
	CurrentTimeRead(ctx context.Context, params protocol.CurrentTimeReadParams) (*protocol.CurrentTimeReadResponse, error)
...
func dispatchServerRequest(ctx context.Context, handler ServerRequestHandler, req JSONRPCRequest) (any, error) {
	...
	case "currentTime/read":
		...
		return handler.CurrentTimeRead(ctx, params)
